...
public class CourseSheetParser {
    public static ArrayList<Student> parseCourseSheet(String courseName, String path) throws IOException {
    ...
    private static ArrayList<Module> createModules(List<String> moduleNames,
                                 List<String> columnNames,
                                 List<String> maxScores) {
    ...
    private static CourseScores createCourseScores(Course course,
                                            List<String> moduleNames,
    ...
    private static TaskType convertStringToTaskType(String taskStr){
